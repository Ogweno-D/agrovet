...
<html>
    ...
    <body>
        <div class="">
            <div class="navbar">
                <div class="">
                    <img src="images/nice logo.png" width="100px" height="90px">
                </div>
                <nav>
                    <ul id="MenuItems">
...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
      ...
      <div class="footer-left">
        <h3 style="font-family: 'Times New Roman', cursive;">AgroPower Farmcare Agro &copy; </h3>
     <div class="logo">
